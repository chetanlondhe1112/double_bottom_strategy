...
config_file_path="F:/project-12/double_bottom_strategy/scratch/trial/config/dbs_config.toml"
...
class sqlalchemy_connect:
    ...
    def __init__(self,username):
        ...
        print(self.config)
        self.encrypt_key=self.config['encrypt_key']
        self.encryption_key=bytes(self.encrypt_key["key"], 'utf-8')
